  ...
  describe('all', () => {
    ...
    it('should send success json response if users in database', async () => {
      ...
      jest
        ...
        .mockResolvedValue([]);
      jest
        .spyOn(followerService, 'getFollowersData')
        .mockResolvedValue([mockFollowerData]);
      ...
      await Get.prototype.all(req, res);
      expect(followerService.getFollowersData).toHaveBeenCalledWith(
  ...
  describe('profileAndPosts', () => {
    it('should send success json response if user in cache', async () => {
      ...
      jest
        ...
        .mockResolvedValue(existingUser);
      jest
        .spyOn(PostCache.prototype, 'getPostsByUserFromCache')
      ...
      expect(PostCache.prototype.getPostsByUserFromCache).toHaveBeenCalledWith(
        'post',
        req.params.uId
      );
      expect(res.status).toHaveBeenCalledWith(200);
