...
describe('EditBasicInfo', () => {
  ...
  describe('info', () => {
    ...
    it('should call updateBasicInfoInDB', async () => {
      ...
      await Edit.prototype.info(req, res);
      expect(userQueue.addUserJob).toHaveBeenCalledWith('updateUserInfo', {
  ...
  describe('social', () => {
    it('should call updateSingleUserItemInCache', async () => {
      ...
      await Edit.prototype.socialLinks(req, res);
      expect(
        UserCache.prototype.updateSingleUserItemInCache
    ...
    it('should call updateSocialLinksInDB', async () => {
      ...
      await Edit.prototype.socialLinks(req, res);
      expect(userQueue.addUserJob).toHaveBeenCalledWith('updateSocialLinks', {
        key: `${req.currentUser?.userId}`,
        value: req.body,
      });
      expect(res.status).toHaveBeenCalledWith(200);
