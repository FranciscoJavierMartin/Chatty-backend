...
describe('Add', () => {
  ...
  describe('profileImage', () => {
    ...
    it('should call updateSingleUserItemInCache method', async () => {
      ...
      const url = `https://res.cloudinary.com/${config.CLOUDINARY_CLOUD_NAME}/image/upload/v1234/123456`;
    ...
    it('should call addImageJob method', async () => {
      ...
      expect(imageQueue.addImageJob).toHaveBeenCalledWith(
        'addUserProfileImageToDB',
        {
          ...
          value: `https://res.cloudinary.com/${config.CLOUDINARY_CLOUD_NAME}/image/upload/v1234/123456`,
          imgId: '123456',
          imgVersion: '1234',
        }
      );
